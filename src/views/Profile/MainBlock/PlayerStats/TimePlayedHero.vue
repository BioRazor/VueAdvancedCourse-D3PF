<template lang="pug">
    .progress-time-TimePlayedHero
        .d-flex.justify-content-between
            h5.mb-0.font-weight-lighter {{ heroTime.hero }}
            span
                b-badge.w-50p {{ (heroTime.time * 100).toFixed(2) }}
        b-progress(:max="1" height="14px" class="mb-3 rounded-0")
            b-progress-bar(:value="heroTime.time" :class="classHeroBg") {{ heroTime.hero }}
</template>
<script>
